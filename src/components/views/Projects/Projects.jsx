          ...
          {projectList &&
            projectList.map((item, idx) => (
              <Col span={24} key={idx}>
                      ...
                      <div className={styles.ls}>
                        ...
                        <div className={styles.contents}>
                          <ul>
                            ...
                            {!!item.detail2 && <li key="2">{item.detail2}</li>}
                            {!!item.detail3 && <li key="3">{item.detail3}</li>}
                            {!!item.detail4 && <li key="4">{item.detail4}</li>}
                            {!!item.detail5 && <li key="5">{item.detail5}</li>}
                          </ul>
                        </div>
                      </div>
                    </Col>
                ...
                {isLogged && <ButtonSet pageFeature="projects" id={item.id} />}
              </Col>
            ))}
        </Row>
      </div>
