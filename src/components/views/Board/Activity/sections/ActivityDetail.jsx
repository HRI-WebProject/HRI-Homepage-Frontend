...
function ActivityDetail() {
  ...
  useEffect(() => {
    pageId &&
      Axios.get(`/board/ACTIVITY/page/${pageId + ""}`).then((res) => {
        if (res.status === 200) {
            ...
            <tbody>
              ...
              <tr>
                <td className={styles.table_td_2}>
                  ...
                  Angle-Insensitive 2.45 GHz RF-Based Energy Harvesting System
                  for IoT Applications"was accepted in IEEE Transactions on
                  Antennas and Propagation. The authors are Jeong-Su Park, and
                  Wang-Sang Lee.{" "}
                </td>
              </tr>
            </tbody>
